...
from .model_utils.misc import find_all_linear_modules, find_expanded_modules, find_expanded_modules_ids
...
def _setup_freeze_tuning(
    ...
    if finetuning_args.use_llama_pro:
        ...
        trainable_layer_ids = find_expanded_modules_ids(model, finetuning_args.freeze_trainable_layers)
